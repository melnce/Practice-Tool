export type KeywordName =
    | "rush" | "storm" | "ward" | "bane" | "drain" | "intimidate" | "ambush"
    | "barrier" | "banish_on_death" | "countdown" | "aura"
    | "last_words" | "cant_be_destroyed" | "trigger" | "rally" | "fanfare"
    | "strike" | "engage" | "enhance" | "spellboost" | "counter" | "skybound_art"
    | "pixie_enter" | "bleed" | "ally_enter" | "cant_attack"
    | "max_damage_cap"
    | string;
