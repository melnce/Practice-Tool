 ...
 */
export function resolveDamageAmount(eff: Effect, ctx: DamageAmountContext): ResolvedDamage {
    ...
    if (eff.add_amount) {
        ...
        console.log(`[DamageDebug] Context Source:`, ctx.sourceCard ? `${ctx.sourceCard.name} (SB: ${ctx.sourceCard.spellboostCount})` : "None");
    }
 ...
 */
export function resolveAmountWithOverflow(eff: Effect, owner: Player, context: any = {}): number {
