 ...
 */
export function getPlayerState(state: GameState, player: PlayerSlot): PlayerState {
...
export function getGraveyard(state: GameState, player: PlayerSlot): CardInstance[] {
    return state.players[player].graveyard;
}

export function getDestroyedHistory(state: GameState, player: PlayerSlot): CardInstance[] {
    return state.players[player].destroyedHistory;
}

export function getPlayedHistory(state: GameState, player: PlayerSlot): import("../logic/core/playCard/types.js").PlayedHistoryEntry[] {
    return state.players[player].playedHistory;
}

export function getShikigamiDeathsThisTurn(state: GameState, player: PlayerSlot): CardInstance[] {
...
export function setHP(state: GameState, player: PlayerSlot, value: number): void {
...
export function setMaxHP(state: GameState, player: PlayerSlot, value: number): void {
...
export function setPP(state: GameState, player: PlayerSlot, value: number): void {
...
export function setMaxPP(state: GameState, player: PlayerSlot, value: number): void {
...
export function setPermPP(state: GameState, player: PlayerSlot, value: number): void {
...
export function setEvoCharges(state: GameState, player: PlayerSlot, value: number): void {
    state.players[player].evoCharges = value;
}

export function getSuperEvoCharges(state: GameState, player: PlayerSlot): number {
    return state.players[player].superEvoCharges;
}

export function setSuperEvoCharges(state: GameState, player: PlayerSlot, value: number): void {
...
export function setEvoCount(state: GameState, player: PlayerSlot, value: number): void {
...
export function getEvoUsedThisTurn(state: GameState, player: PlayerSlot): boolean {
    return state.players[player].evoUsedThisTurn;
}

export function setEvoUsedThisTurn(state: GameState, player: PlayerSlot, value: boolean): void {
...
export function setPlaysThisTurn(state: GameState, player: PlayerSlot, value: number): void {
    state.players[player].playsThisTurn = value;
}

export function incrementPlaysThisTurn(state: GameState, player: PlayerSlot): void {
...
export function setShadows(state: GameState, player: PlayerSlot, value: number): void {
    state.players[player].shadows = value;
}

export function addShadows(state: GameState, player: PlayerSlot, amount: number): void {
...
export function addModeBonus(state: GameState, player: PlayerSlot, amount: number): void {
...
export function setRally(state: GameState, player: PlayerSlot, value: number): void {
...
export function getCrests(state: GameState, player: PlayerSlot): import("../logic/effects/crest.js").Crest[] {
    return state.players[player].crests;
}

export function setCrests(state: GameState, player: PlayerSlot, crests: import("../logic/effects/crest.js").Crest[]): void {
...
export function setLeaderBarrier(state: GameState, player: PlayerSlot, value: number): void {
    state.players[player].leaderBarrier = value;
}

export function getLeaderDamageTakenBonus(state: GameState, player: PlayerSlot): number {
    return state.players[player].leaderDamageTakenBonus;
}

export function setLeaderDamageTakenBonus(state: GameState, player: PlayerSlot, value: number): void {
    state.players[player].leaderDamageTakenBonus = value;
}

export function getLeaderMaxDamageCap(state: GameState, player: PlayerSlot): number | null {
    return state.players[player].leaderMaxDamageCap;
}

export function setLeaderMaxDamageCap(state: GameState, player: PlayerSlot, value: number | null): void {
...
export function getAnyAllyAttackedThisTurn(state: GameState, player: PlayerSlot): boolean {
    return state.players[player].anyAllyAttackedThisTurn;
}

export function setAnyAllyAttackedThisTurn(state: GameState, player: PlayerSlot, value: boolean): void {
...
export function setDeckoutWins(state: GameState, player: PlayerSlot, value: boolean): void {
...
export function getDeckFile(state: GameState, player: PlayerSlot): string | undefined {
    return state.players[player].deckFile;
}

export function setDeckFile(state: GameState, player: PlayerSlot, value: string): void {
...
export function getBackrow(_state: GameState, _player: PlayerSlot): CardInstance[] {
