...
describe("dev-guards soak — targeted-op handler scope", () => {
  ...
  it("destroy targeted handler: amulet destroy fires ally_amulet_destroyed → runEffects (Omerio)", () => {
  ...
  it("destroy targeted handler: amulet last words fire runEffects inside handler", () => {
    const amulet = createCard(
      {
        name: "LW Amulet",
        type: "Amulet",
  ...
  it("damage targeted handler: dealDamage fires self_damaged trigger inside handler", () => {
