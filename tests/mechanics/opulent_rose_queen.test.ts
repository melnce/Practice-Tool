        ...
        it("only transforms cards costing 2 or less", () => {
            ...
            givenGameState({ seed: 1 })
                .withFirstHand([
                    ...
                    { name: "LowCost2", type: "Follower", cost: "2", class: "Forestcraft" },
                    { name: "MidCost", type: "Spell", cost: "3", class: "Forestcraft" },
                    { name: "HighCost", type: "Follower", cost: "5", class: "Forestcraft" },
                    { name: "OtherClass", type: "Spell", cost: "1", class: "Swordcraft" },
                ])
                .build();

            const sourceCard = { name: "Opulent Rose Queen", type: "Follower", uid: "test-orq" } as any;
