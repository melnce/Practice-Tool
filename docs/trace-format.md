...
| `field[].traits`          | keyword flags on card (`ambush`, `ward`, `storm`, `rush`, `bane`, …)   | sorted lowercase                                                                                                                                                                                                                                                      |
| `field[].vars`            | `card.counters` keys X/Y/Z only                                        | emitted only when present                                                                                                                                                                                                                                             |
| `field[].granted`         | `keywordState` triggers / `lastWordsEffects` / `triggers[]` event tags | sorted camelCase tags; approximate — engine has no single grant registry                                                                                                                                                                                              |
...
| `pp`                      | `players[*].pp`                                                        |                                                                                                                                                                                                                                                                       |
| `pp_bonus`                | `players[*].bonusPpOrb`                                                | second-player bonus orb                                                                                                                                                                                                                                               |
| `pp_max`                  | `players[*].maxPP`                                                     |                                                                                                                                                                                                                                                                       |
| `rally`                   | `players[*].rally`                                                     |                                                                                                                                                                                                                                                                       |
