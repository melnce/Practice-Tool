...
if (card.keywordState.cantAttackExpiresOnTurn !== 5) {
    console.error("FAILURE: expires_on_turn not set! Got:", card.keywordState.cantAttackExpiresOnTurn);
} else {
...
console.log("After Blue End Turn keywordState:", JSON.stringify(card2.keywordState));
...
console.log("After Red End Turn keywordState:", JSON.stringify(card2.keywordState));
