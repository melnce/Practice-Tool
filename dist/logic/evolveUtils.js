...
function queueRender() {
    ...
    __raf = requestAnimationFrame(() => { __raf = null; try {
        render();
    }
    catch { } });
}
export function canEvolve(owner, card, mode = "normal") {
...
export function onEvolve(card, owner, mode, { spendPoint = true, skipEffects = false } = {}) {
    if (!card)
        return;
...
export function superEvolveAllyFromContext(owner, sourceCard, context) {
